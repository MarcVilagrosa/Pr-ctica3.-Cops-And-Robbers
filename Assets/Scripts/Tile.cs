...
//-------------------------------------------------------------
    ...
    //Nueva propiedad para indicar si la casilla esta ocupada
    public bool occupied = false;

    //Propiedad para indicar si la casilla esta ocupada por el otro policia
    public bool occupiedByOtherCop = false;
...
//-------------------------------------------------------------
        //Reiniciamos la propiedad ocupada
        occupied = false;

        //Reiniciamos la propiedad ocupada por el otro policia
        occupiedByOtherCop = false;
